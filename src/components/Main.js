...
function Main(props) {
    ...
    return (
        <div className='main'>
            ...
            {props.theMainState >= 1 ? <LifeLinePopUps initTimer={props.initTimer} timerSeconds={props.timerSeconds} changeTimerSeconds={props.changeTimerSeconds} mainStateFlag={props.mainStateFlag} current_money={props.currentMoney}/> : null}
