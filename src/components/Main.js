...
function Main(props) {
    return (
        <div className='main'>
            <LifeLineContainer gameStateFlag={props.gameStateFlag} lifeline_fiftyfifty={props.lifeline_fiftyfifty} lifeline_phoneafriend={props.lifeline_phoneafriend} lifeline_asktheaudience={props.lifeline_asktheaudience}/>
            {props.theMainState === 1 ? <LifeLinePopUps current_money={props.currentMoney}/> : null}
